...
namespace stryktipsetLibrary
{
    ...
    {
        string connStr = "Data Source=DANIEL\\SQLEXPRESS;Initial Catalog = football; Integrated Security = True providerName=Microsoft.SqlClient";
